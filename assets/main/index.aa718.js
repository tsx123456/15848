...
System.register("chunks:///_virtual/FortuneSetBase.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ConfigManager.ts', './DataManager.ts', './EventManager.ts', './ViewManager.ts', './Common.ts', './FortuneScrollView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Enum, Label, Node, Component, ConfigManager, DataManager, UserKey, EventManager, ViewManager, Common, FortuneScrollView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var FortuneSetBase = exports('default', (_dec = ccclass("FortuneSetBase"), _dec2 = menu("Fortune/FortuneSetBase"), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.setData = function setData(data) {
          ...
          this.betSizeIdx = data.betSizeIdx;
          this.betLevelIdx = data.betLevelIdx;
          this.betLinesIdx = data.betLinesIdx;
          this.betAmountIdx = data.betAmountIdx;
          this.Label_bet.string = "" + Common.moneyFormat(data.betAmountList[data.betAmountIdx]);
          this.scrollView_baseScore.getComponent(FortuneScrollView).setData(data.betSizeList, this.betSizeIdx);
          this.scrollView_baseRate.getComponent(FortuneScrollView).setData(data.betLevelList, this.betLevelIdx);
          this.scrollView_basePay.getComponent(FortuneScrollView).setData(data.betLinesList, this.betLinesIdx);
          this.scrollView_baseBet.getComponent(FortuneScrollView).setData(data.betAmountList, this.betAmountIdx);
        };
        _proto.onEnable = function onEnable() {
